...
#define DDR_tRTP 7.5//10   /* 7.5ns READ to PRECHARGE command period. */
...
#define DDR_tRRD 7.5//8  /* ACTIVE bank A to ACTIVE bank B command period. */
#define DDR_tWR  15//20  /* WRITE Recovery Time defined by register MR of DDR2 memory */
#define DDR_tWTR 7.5  /* WRITE to READ command delay. */

/*
 * DDR2 controller timing2 register
 */
#define DDR_tRFC 75 /* ns,  AUTO-REFRESH command period. */
#define DDR_tMINSR 140//6 /* Minimum Self-Refresh / tXSNR */
